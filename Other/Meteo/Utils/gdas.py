...
def main():
    ...
    parser.add_argument('-r', '--res',     help='spatial resolution (deg) [Default: %(default)s]', default=0.25,                   type=float,     choices=(0.25,))
    parser.add_argument('-c', '--cycle',   help='cycle [Default: %(default)s]',                    default=0,                      type=int,       choices=(0, 6, 12, 18))
    parser.add_argument('-s', '--step',    help='temporal resolution (h) [Default: %(default)s]',  default=3,                      type=int,       choices=(3, 6))
